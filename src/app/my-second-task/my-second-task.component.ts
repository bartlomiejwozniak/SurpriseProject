...
@Component({
  selector: 'app-my-second-task',
  templateUrl: './my-second-task.component.html',
  styleUrls: ['./my-second-task.component.css']
})
export class MySecondTaskComponent {
  constructor(public dialogRef: MatDialogRef<MySecondTaskComponent>,  @Inject(MAT_DIALOG_DATA) public data: any) {
